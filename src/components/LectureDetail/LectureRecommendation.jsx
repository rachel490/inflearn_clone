        ...
        <Item>
            ...
            <InfoWrap>
                <Info>
                    ...
                    <Tags>
                        <Tag bgColor="hsl(216.97802846099137,53.40494204840556%,90.56660587080923%)">TypeScript</Tag>
                        <Tag bgColor="hsl(355.1331456561915,69.09826004032358%,90.36852227234142%)">Front-End</Tag>
                        <Tag bgColor="hsl(63.090242388817465,78.32854757000368%,89.73051654065193%)">ES6</Tag>
                    </Tags>
                    <Rate>
                        <StarRate rate={5}/>
...
const LectureRecommendation = () => {
    return (
        <Container>
            <Header>
                <Title>장기효(캡틴판교)님의 다른 강의 <BiLinkExternal/></Title>
